...
const ROLE_DESCRIPTIONS: Record<string, string> = {
  owner: "Вы видите все разделы и управляете настройками школы.",
  admin: "Вы работаете с учениками, расписанием, уроками и учебными материалами.",
  branch_manager: "Вы организуете ежедневную работу филиала и контролируете уроки.",
  curator: "Вы следите за учениками, домашними заданиями и обратной связью.",
  teacher: "Вы видите своих учеников, проводите уроки и заполняете отчёты.",
  student: "Вы видите своё расписание, материалы, задания и результаты.",
  parent: "Вы видите разрешённые расписание, баланс, прогресс плана, достижения и новости ребёнка.",
  super_admin: "Вам доступны все разделы школы.",
};
